          ...
          <v-col cols="7">
            ...
            >
              ...
              <div class="mt-2">
                <v-row>
                  <v-col
                    ><h4 style="color: #54b8f6">1 año <br> 6 meses </h4>
                    <h5 class="white--text">Experiencia</h5>
                  </v-col>
                  <v-col
                    ><h4 style="color: #54b8f6">4</h4>
                    <h5 class="white--text">Proyectos <br> Profesionales </h5></v-col
                  >
                  <v-col
...
export default {
  ...
  data: () => ({
    ...
    icons: [
      {
        icon: "mdi-google",
        link: "mailto:osopandassj4@gmail.com",
        color: "red",
      },
      {
        icon: "mdi-instagram",
